...
<section class="relative font-sans bg-[#f7faff] overflow-hidden mt-0 mx-4 mb-4 sm:mt-0 sm:mx-6 sm:mb-6 rounded-t-none rounded-b-[2rem] lg:m-0 lg:rounded-none">
    <div class="absolute inset-0 z-0">
        <img src="<?= e(asset_url('images/bg-5.png')) ?>" alt="bg" class="hero-parallax-img w-full h-full object-cover object-[75%_center] opacity-100 mix-blend-screen">
...
<section class="relative pt-6 pb-10 lg:pt-10 lg:pb-20 overflow-hidden">
    ...
    <div class="relative mx-auto w-full max-w-[1720px] px-4 sm:px-6 lg:px-10">
        <div class="lg:px-12 xl:px-24">
            ...
            <?php endif; ?>
            <div class="mx-auto w-full py-8 mt-10">
