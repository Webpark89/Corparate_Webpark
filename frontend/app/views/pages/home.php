    ...
    <div class="mx-auto w-full max-w-[1720px] px-4 sm:px-6 lg:px-10 pt-8 pb-12 md:pt-12 md:pb-24 lg:pt-28 lg:pb-32 relative z-10 ipad-air-landscape-hero-container">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:pb-12 lg:gap-10 items-center relative z-10">
            <div class="max-w-3xl relative z-10 text-left mx-0 flex flex-col items-start w-full desktop-home-hero-col ipad-air-landscape-left-col">
                ...
                <h1 class="animate-entrance-up delay-200 mb-2 tracking-tight flex flex-col items-start leading-tight text-5xl md:text-7xl lg:text-8xl font-black home-hero-h1-wrapper">
                    <span class="bg-gradient-to-r from-[#898F98] via-[#5d636b] to-[#000208] bg-clip-text text-transparent animate-text-gradient inline-block py-1 md:py-2 whitespace-nowrap desktop-home-hero-h1">WEBPARK</span>
                    <span class="bg-gradient-to-r from-[#003380] via-[#2563eb] to-[#0055ff] bg-clip-text text-transparent animate-text-gradient inline-block py-1 md:py-2 whitespace-nowrap desktop-home-hero-h1" style="animation-delay: -3s;">COMPANY</span>
                </h1>
                <p class="animate-entrance-up delay-300 mt-6 text-blue-900 md:text-[#0b1b42] text-base md:text-lg leading-relaxed max-w-lg mx-0 mb-10 font-bold md:font-semibold w-11/12 sm:w-3/4 md:w-full text-left relative z-20 ipad-pro-hero-desc ipad-mini-hero-desc mobile-hero-desc desktop-home-hero-p">
                    ...
                    <span class="hidden md:inline">
                        <?php if (getCurrentLang() === 'th'): ?>
                            <span class="inline-block md:whitespace-nowrap">ผู้ให้บริการพัฒนา Digital Platform และระบบ AI</span><br class="hidden md:inline">
                            <span class="inline-block md:whitespace-nowrap">ที่ช่วยให้ธุรกิจไทยก้าวไปข้างหน้า</span><br class="hidden md:inline">
                            <span class="inline-block md:whitespace-nowrap">ด้วยเทคโนโลยีที่ใช้งานได้จริง</span>
                        <?php else: ?>
                            <span class="inline-block md:whitespace-nowrap">Digital Platform and AI system development provider</span><br class="hidden md:inline">
                            <span class="inline-block md:whitespace-nowrap">helping Thai businesses move forward with</span><br class="hidden md:inline">
                            <span class="inline-block">practical technology.</span>
                        <?php endif; ?>
                    </span>
                </p>
        ...
        <style>
            ...
            /* iPad Mini Portrait & iPad Air Portrait (760px - 834px) */
            @media (min-width: 760px) and (max-width: 834px) {
                ...
                /* About Us & Services Cards Font Sizes for iPad Mini / Air */
                .ipad-air-font-about-tag { font-size: 0.95rem !important; }
                .ipad-air-font-about-h2 { font-size: 1.45rem !important; line-height: 1.8rem !important; }
                .ipad-air-font-title { font-size: 1.15rem !important; line-height: 1.45rem !important; min-height: 2.5rem !important; font-weight: 700 !important; }
                .ipad-air-font-desc { font-size: 0.925rem !important; line-height: 1.55rem !important; min-height: 4.75rem !important; }
                .ipad-air-font-link { font-size: 0.925rem !important; line-height: 1.45rem !important; }

                /* Articles Section Font Sizes for iPad Mini / Air */
                .ipad-air-article-h2 { font-size: 1.85rem !important; line-height: 1.25 !important; }
                .ipad-air-article-h3 { font-size: 1.35rem !important; line-height: 1.35 !important; }
                .ipad-air-article-desc { font-size: 0.95rem !important; line-height: 1.55 !important; }
                .ipad-air-card-title { font-size: 1.15rem !important; line-height: 1.4 !important; font-weight: 700 !important; }
                .ipad-air-card-desc { font-size: 0.925rem !important; line-height: 1.5 !important; }
                .ipad-air-card-link { font-size: 0.9rem !important; line-height: 1.4 !important; }
                .ipad-air-card-badge { font-size: 0.8rem !important; padding: 0.25rem 0.6rem !important; }
            }
...
/* Dedicated Large Font Scale for iPad Pro (1024px - 1440px) */
@media (min-width: 1024px) and (max-width: 1440px) {
    ...
    /* About Us & 4 Services Cards Overrides */
    .ipad-pro-about-br { display: inline !important; }
    .ipad-pro-font-about-tag { font-size: 1.35rem !important; line-height: 1.8rem !important; font-weight: 800 !important; color: #0663F6 !important; }
    .ipad-pro-about-bar { width: 4.5rem !important; height: 4px !important; margin-top: 0.4rem !important; margin-bottom: 0.75rem !important; background-color: #0663F6 !important; }
    .ipad-pro-font-about-h2 { font-size: 1.85rem !important; line-height: 2.3rem !important; font-weight: 800 !important; min-height: 4.5rem !important; margin-bottom: 0.75rem !important; color: #043B94 !important; }
    .ipad-pro-font-title {
    ...
    .ipad-pro-font-h2 { font-size: 3.25rem !important; line-height: 1.15 !important; }
    .ipad-pro-font-subtitle { font-size: 2.5rem !important; line-height: 2.8rem !important; }
    
    /* Partner Logos Section */
    .ipad-pro-partner-title {
        font-size: 2.5rem !important;
        line-height: 1.25 !important;
        font-weight: 800 !important;
        margin-bottom: 1.25rem !important;
    }
    .ipad-pro-partner-desc {
        font-size: 1.25rem !important;
        line-height: 1.8 !important;
    ...
    /* Articles Section */
    .ipad-pro-article-h2 { font-size: 3.25rem !important; line-height: 1.15 !important; }
    .ipad-pro-article-h3 { font-size: 2.25rem !important; line-height: 1.35 !important; }
    .ipad-pro-article-desc { font-size: 1.35rem !important; line-height: 2.1rem !important; color: #334155 !important; font-weight: 500 !important; }
    .ipad-pro-card-title { font-size: 1.65rem !important; line-height: 2.1rem !important; font-weight: 800 !important; }
    .ipad-pro-card-desc { font-size: 1.25rem !important; line-height: 1.85rem !important; color: #334155 !important; font-weight: 500 !important; }
    .ipad-pro-card-link { font-size: 1.2rem !important; line-height: 1.6rem !important; font-weight: 700 !important; }
    .ipad-pro-card-badge { font-size: 1.05rem !important; padding: 0.45rem 1rem !important; }
}

/* Dedicated Font Scale for Tablets & iPad Air / Mini (768px - 1023px) */
@media (min-width: 768px) and (max-width: 1023px) {
    ...
    .ipad-pro-article-h3, .ipad-air-article-h3 { font-size: 1.85rem !important; line-height: 1.35 !important; }
    .ipad-pro-article-desc, .ipad-air-article-desc { font-size: 1.25rem !important; line-height: 1.75rem !important; color: #334155 !important; font-weight: 500 !important; }
    .ipad-pro-card-title, .ipad-air-card-title { font-size: 1.45rem !important; line-height: 1.45 !important; }
    .ipad-pro-card-desc, .ipad-air-card-desc { font-size: 1.15rem !important; line-height: 1.65 !important; color: #334155 !important; }
...
<section class="relative pt-6 pb-6 lg:pt-8 lg:pb-10 overflow-hidden">
    ...
    <div class="relative mx-auto w-full max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto w-full max-w-7xl py-8 mt-10">
            <h2 class="text-center text-primary font-bold text-2xl md:text-3xl tracking-normal uppercase mb-3 block ipad-pro-partner-title">
            ...
            <p class="text-center mt-6 text-sm md:text-base text-slate-500 tracking-wide font-medium ipad-pro-partner-desc">
...
<section class="bg-slate-50 pt-6 pb-10 lg:py-10 border-t border-slate-100">
    <div class="mx-auto w-full max-w-[1720px] px-4 sm:px-6 lg:px-10">
        <div class="hidden lg:flex flex-row items-end justify-between mb-6 ipad-pro-hidden lg:ml-12 ipad-pro-ml-0 xl:ml-24 lg:mr-12 xl:mr-24">
            <div>
                <h2 class="text-primary font-black text-3xl tracking-normal m-0 inline-block ipad-pro-article-h2">
                    <?= getCurrentLang() === 'th' ? 'บทความ' : 'Articles' ?>
                </h2>
                <div class="w-12 h-1 bg-primary mt-2 mb-4 rounded-full"></div>
                <h3 class="text-[#043B94] font-bold text-xl mb-3 tracking-tight ipad-pro-article-h3">
                    <?= getCurrentLang() === 'th' ? 'สาระน่ารู้จาก WEBPARK' : 'Knowledge from WEBPARK' ?>
                </h3>
                <p class="text-slate-500 text-sm leading-[1.6] font-medium m-0 ipad-pro-article-desc">
        ...
        <div class="lg:hidden mb-6 flex flex-col items-start text-left ipad-pro-flex-visible">
            ...
            <p class="text-slate-600 text-sm md:text-base leading-[1.6] font-medium ipad-pro-article-desc ipad-air-article-desc">
