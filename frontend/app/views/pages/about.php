...
<section class="bg-white pt-10 pb-8 lg:pt-20 lg:pb-24">
    <div class="mx-auto w-full max-w-7xl px-6 sm:px-6 lg:px-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="max-w-xl">
                <h2 class="text-3xl md:text-4xl lg:text-[2.75rem] font-bold leading-normal py-2 mb-0 lg:mb-3" style="color: #0663F6;">
...
<section class="bg-[#f8fafc] pt-8 pb-8 lg:pt-24 lg:pb-16 font-sans">
    <div class="mx-auto w-full max-w-7xl px-6 sm:px-6 lg:px-6"> 
