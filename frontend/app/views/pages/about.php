...
<section class="bg-white py-16 lg:py-24">
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-4 lg:px-6"> 
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-16 items-center">
            ...
            <div class="max-w-xl">
                <h2 class="text-3xl md:text-4xl lg:text-[2.75rem] font-bold text-dark leading-tight mb-3">
                    เกี่ยวกับเรา
                </h2>

                <span class="text-primary ftext-blue-600 text-xl leading-relaxed mb-8 block">
    ...
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-4 lg:px-6"> 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <?php foreach ($services as $item): ?>
                <div class="bg-white rounded-2xl p-8 border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:-translate-y-1 hover:shadow-lg transition-all duration-300 group cursor-pointer hover:bg-primary">
