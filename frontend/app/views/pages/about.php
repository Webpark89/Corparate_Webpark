    ...
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-4 lg:px-6"> 
        <div class="grid grid-cols-1 lg:grid-cols-[40%_55%] gap-12 lg:gap-16 justify-between items-start">
            ...
            <div class="flex flex-col gap-4">
                <?php
                $processes = [
                    ['step' => '01', 'title' => 'เข้าใจธุรกิจของคุณ',      'desc' => 'เราทำความเข้าใจเป้าหมาย ความต้องการ และกระบวนการทำงานของธุรกิจ เพื่อออกแบบแนวทางที่ตอบโจทย์ได้อย่างเหมาะสม', 'icon' => asset_url('images/icon-1.png')],
                    ['step' => '02', 'title' => 'ออกแบบให้ใช้งานได้จริง', 'desc' => 'เราออกแบบระบบให้ใช้งานง่าย รองรับการขยายตัว และสอดคล้องกับกระบวนการทำงานของธุรกิจ',                              'icon' => asset_url('images/icon-2.png')],
                    ['step' => '03', 'title' => 'ดูแลอย่างต่อเนื่อง',       'desc' => 'เราพร้อมให้คำปรึกษาและบริการหลังการขายอย่างต่อเนื่อง เพื่อสร้างความมั่นใจตลอดการใช้งาน',                         'icon' => asset_url('images/icon-3.png')],
                    ['step' => '04', 'title' => 'รองรับการเติบโต',          'desc' => 'เราพัฒนาระบบที่ยืดหยุ่น สามารถขยายตัวได้ และปรับตามธุรกิจที่เติบโตในอนาคต',                                          'icon' => asset_url('images/icon-4.png')],
                ];
                ?>

                <?php foreach ($processes as $item): ?>
                    <div class="bg-white rounded-2xl p-5 border border-slate-100 shadow-[0_2px_12px_rgba(4,59,148,0.06)] flex items-start gap-5 hover:border-blue-200 hover:shadow-md transition-all group">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <p class="text-slate-500 text-sm leading-relaxed"><?= e($item['desc']) ?></p>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <?php foreach ($services as $srv): ?>
                <div class="bg-white rounded-2xl p-8 border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:-translate-y-1 hover:shadow-lg transition-all duration-300 group cursor-pointer
                    ...
                    <h3 class="text-dark font-bold text-lg mb-3 group-hover:text-white transition-colors"><?= e($srv['title']) ?></h3>
