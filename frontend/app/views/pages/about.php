        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div class="max-w-2xl">
                ...
                <h1 class="text-5xl md:text-6xl lg:text-[4.5rem] font-bold text-dark leading-[1.1] mb-2 tracking-tight">
                    ผู้ใหบริการด้าน<br>
                    <span class="text-primary">ERP / ERM</span>
                </h1>

                <p class="mt-6 text-slate-700 text-base md:text-lg leading-relaxed max-w-lg mb-10 font-medium">
                    WEBPARK ผู้เชียวชาญด้าน ERP/ERM และระบบดิจิทัล<br>ครบวงจร เราช่วยให้องค์กรของคุณทำงานอย่างชาญฉลาด<br>ด้วยเทคโนโลยีล้ำสมัยแพลตฟอร์มดจิทัลและ AI <br>เพื่อการเติบโตที่ยั่งยืนในยุคดิจิทัล                </p>
                ...
                <div class="flex flex-wrap items-center gap-4">
                    ...
                    <a href="#about" class="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-white text-slate-700 text-sm font-semibold rounded-full hover:bg-slate-50 transition-all shadow-sm border border-slate-200 hover:-translate-y-0.5">
                        เกี่ยวกับเรา
...
<section class="bg-white py-16 lg:py-24">
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-4 lg:px-6"> 
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-16 items-center">
            ...
            <div class="max-w-xl">
                <span class="inline-block px-4 py-1.5 rounded-full border border-blue-200 bg-blue-50 text-primary text-xs font-bold tracking-widest uppercase mb-6">
                    ABOUT US
                </span>
    ...
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-4 lg:px-6"> 
        <div class="bg-dark rounded-[2rem] overflow-hidden relative shadow-2xl flex flex-col md:flex-row items-center min-h-[300px] lg:min-h-[400px]">
            ...
            <div class="relative z-20 p-8 md:p-12 lg:p-16 w-full md:w-1/2">
                <span class="inline-block px-4 py-1.5 rounded-full border border-blue-400/30 bg-blue-500/10 text-blue-300 text-[10px] md:text-xs font-bold tracking-widest uppercase mb-4">
                    OUR PORTFOLIO
                </span>
                ...
                <a href="<?= e(route_url('/portfolio')) ?>" class="inline-flex items-center gap-2 px-6 py-2.5 bg-white text-dark text-sm font-bold rounded-full hover:bg-blue-50 transition-all">
                    ดูผลงานของเรา
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                    </svg>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[40%_55%] gap-12 lg:gap-0 justify-between items-start">
            ...
            <div class="sticky top-24">
                ...
                <p class="text-slate-600 text-sm md:text-base leading-relaxed max-w-md">
                    เราเชื่อว่าการพัฒนาระบบและโซลูชันดิจิทัลที่ดี ไม่ได้เริ่มจากเทคโนโลยีเพียงอย่างเดียว แต่เริ่มจากความเข้าใจธุรกิจของคุณ เราทำงานแบบพาร์ทเนอร์ร่วมคิด ร่วมสร้าง เพื่อให้ทุกโซลูชันที่เราส่งมอบ สามารถใช้งานได้จริง สร้างคุณค่า และช่วยให้ธุรกิจของคุณเติบโตได้อย่างยั่งยืน
                </p>
            </div>
                ...
                <?php foreach ($processes as $item): ?>
                    <div class="bg-white rounded-2xl p-6 border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex items-start gap-6 hover:border-blue-200 hover:shadow-md transition-all group">
                        ...
                        <div>
                            ...
                            <p class="text-slate-500 text-[13px] leading-relaxed"><?= $item['desc'] ?></p>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
...
<section class="bg-[#f8fafc] py-16 lg:py-24 font-sans">
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-4 lg:px-6"> 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php
            $services = [
                ['title' => 'พัฒนาระบบซอฟต์แวร์', 'desc' => 'ออกแบบและพัฒนาระบบที่ตอบโจทย์ความต้องการเฉพาะขององค์กร', 'icon' => 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4'],
                ['title' => 'ระบบสำหรับองค์กร', 'desc' => 'วางโครงสร้างระบบองค์กรที่แข็งแกร่ง รองรับการทำงานและประสิทธิภาพที่เพิ่มขึ้น', 'icon' => 'M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01'],
                ['title' => 'การตลาดออนไลน์', 'desc' => 'วางกลยุทธ์การตลาดออนไลน์ครบวงจร เพิ่มการมองเห็นและสร้างโอกาสทางธุรกิจ', 'icon' => 'M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z'],
                ['title' => 'เว็บไซต์และแอปพลิเคชัน', 'desc' => 'พัฒนาเว็บไซต์และแอปพลิเคชันที่สวยงาม ใช้งานง่าย รองรับทุกอุปกรณ์', 'icon' => 'M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z'],
                ['title' => 'AI Agent และระบบอัตโนมัติ', 'desc' => 'ผสานพลัง AI และระบบอัตโนมัติ เพื่อเพิ่มประสิทธิภาพและลดต้นทุนการทำงาน', 'icon' => 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z'],
                ['title' => 'งานออกแบบดิจิทัล', 'desc' => 'สร้างสรรค์งานออกแบบดิจิทัลคุณภาพสูง สื่อสารแบรนด์อย่างมืออาชีพ', 'icon' => 'M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z']
            ];
            ?>
            ...
            <?php foreach ($services as $srv): ?>
                <div class="bg-white rounded-2xl p-8 border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:-translate-y-1 hover:shadow-lg transition-all duration-300 group cursor-pointer">
                    <div class="w-12 h-12 mb-6 text-primary group-hover:scale-110 transition-transform">
                        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="<?= $srv['icon'] ?>" />
                        </svg>
                    </div>
                    <h3 class="text-dark font-bold text-lg mb-3 group-hover:text-primary transition-colors"><?= $srv['title'] ?></h3>
