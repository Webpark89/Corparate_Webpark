...
<section class="relative overflow-hidden font-sans">
    ...
    <span class="bg-gradient-to-r from-[#898F98] to-[#000208] bg-clip-text text-transparent">ผู้ให้บริการด้าน</span><br>
    <span class="bg-gradient-to-r from-[#003380] to-[#0055ff] bg-clip-text text-transparent">ERP / ERM</span>
</h1>
