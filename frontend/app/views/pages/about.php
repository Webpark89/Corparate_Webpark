...
<style>
    ...
    /* ขยายรูปรถแล็ปท็อปให้ใหญ่และเยื้องขึ้นบน เฉพาะบนจอ Desktop เพื่อไม่กระทบ iPad */
...
<section id="about-hero" class="relative font-sans bg-[#f7faff] overflow-hidden mt-0 mx-4 mb-4 sm:mt-0 sm:mx-6 sm:mb-6 rounded-t-none rounded-b-[2rem] lg:m-0 lg:rounded-none">
    <div class="absolute inset-0 z-0">
        <img src="<?= e($heroImage) ?>" alt="WEBPARK Solutions Background" class="hero-parallax-img w-full h-full object-cover object-center opacity-70 mix-blend-screen desktop-bg-vibrant">
        <div class="absolute inset-0 bg-gradient-to-r from-white to-white/5 desktop-overlay-vibrant"></div>
    ...
    <div class="mx-auto w-full max-w-[1720px] px-6 sm:px-6 lg:px-10 pt-12 pb-16 lg:pt-28 lg:pb-16 relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-12 lg:gap-20 items-center relative z-10">
            <div class="max-w-2xl">
                ...
                <h1 class="animate-fade-up delay-200 text-5xl sm:text-4xl md:text-6xl lg:text-8xl font-bold leading-[1.1] mb-2 tracking-tighter">
                    <span class="bg-gradient-to-r from-[#898F98] via-[#5d636b] to-[#000208] bg-clip-text text-transparent animate-text-gradient inline-block py-3 desktop-hero-nowrap"><?= e(getCurrentLang() === 'th' ? 'ผู้ให้บริการด้าน' : 'Service Provider for') ?></span><br class="hidden sm:inline">
    ...
    <div class="mx-auto w-full max-w-[1720px] px-6 sm:px-6 lg:px-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="about-intro-text max-w-xl xl:max-w-2xl opacity-0 translate-y-10">
                ...
                <p class="text-slate-600 text-base md:text-lg xl:text-xl leading-relaxed mb-6">
                ...
                <p class="text-slate-600 text-base md:text-lg xl:text-xl leading-relaxed mb-10">
...
<section class="bg-white py-8 lg:py-24 font-sans">
    <div class="mx-auto w-full max-w-7xl px-6 sm:px-6 lg:px-6"> 
        <div class="grid grid-cols-1 xl:grid-cols-[40%_55%] gap-12 xl:gap-16 justify-between items-start desktop-concept-grid">
            <div class="xl:top-8 self-start text-center xl:text-left mx-auto xl:mx-0 flex flex-col items-center xl:items-start w-full desktop-concept-text">
                ...
                <p class="text-slate-600 text-base md:text-lg leading-relaxed max-w-2xl xl:max-w-md mx-auto xl:mx-0 desktop-concept-p">
                ...
                <?php foreach ($processes as $item): ?>
                    <div class="gsap-process-item bg-white rounded-2xl p-5 border border-slate-100 shadow-[0_2px_12px_rgba(4,59,148,0.06)] flex items-center gap-5 hover:border-blue-200 hover:shadow-md transition-all group opacity-0 translate-y-10">
                        ...
                        <div class="flex flex-col gap-1 desktop-about-process-content">
                            <div class="flex flex-col desktop-about-process-header">
                                <span class="text-xl font-extrabold desktop-about-process-step" style="color: #043B94;"><?= e($item['step']) ?></span>
                                <h4 class="text-dark font-bold text-base group-hover:text-primary transition-colors desktop-about-process-title"><?= e($item['title']) ?></h4>
                            </div>
                            <p class="text-slate-500 text-sm leading-relaxed desktop-about-process-desc"><?= $item['desc'] ?></p>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
...
<section id="about-services-scroll" class="bg-[#f8fafc] pt-8 pb-8 lg:pt-24 lg:pb-16 font-sans">
    <div class="mx-auto w-full max-w-7xl px-6 sm:px-6 lg:px-6 desktop-wide-container"> 
        <div class="mb-2">
            <h2 class="text-3xl md:text-4xl font-bold text-primary mb-4 desktop-services-title">
