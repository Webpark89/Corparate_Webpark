...
<section id="about-services-scroll" class="bg-[#f8fafc] pt-8 pb-8 lg:pt-24 lg:pb-16 font-sans ipad-pro-services-section">
    <div class="mx-auto w-full max-w-7xl px-6 sm:px-6 lg:px-6 desktop-wide-container"> 
        ...
        <div id="service-scroll-container" class="flex overflow-x-auto snap-x snap-mandatory scrollbar-none gap-6 pb-6 -mx-4 px-4 md:mx-0 md:px-0 md:grid md:grid-cols-2 lg:grid-cols-3 md:overflow-visible md:snap-none desktop-services-grid">
            <?php
            $services = [
                ['title' => getCurrentLang() === 'th' ? 'พัฒนาระบบซอฟต์แวร์' : 'Software Development', 'desc' => getCurrentLang() === 'th' ? 'ออกแบบและพัฒนาระบบที่ตอบโจทย์<br class="ipad-pro-hidden-br ipad-air-hidden-br">ความต้องการเฉพาะขององค์กร' : 'Design and develop systems tailored to <br class="ipad-pro-hidden-br ipad-air-hidden-br"> your organization\'s specific needs', 'icon' => asset_url('images/about_5.svg')],
