...
<section id="erp-hero" class="relative font-sans bg-[#f7faff] overflow-hidden mt-0 mx-0 mb-4 sm:mt-0 sm:mx-6 sm:mb-6 rounded-t-none rounded-b-[2rem] lg:m-0 lg:rounded-none">
...
<section class="bg-white pt-6 pb-0 lg:pt-10 lg:pb-0 erp-intro-section">
...
<section id="modules" class="bg-slate-50 pt-4 pb-6 lg:pt-6 lg:pb-8 font-sans border-t border-slate-100 erp-modules-section">
...
<section class="bg-slate-50 py-6 lg:py-8 font-sans border-t border-slate-100">
    <div class="mx-auto max-w-7xl px-6 sm:px-6 lg:px-8">
...
<section class="bg-white py-6 lg:py-10 font-sans">
    <div class="mx-auto max-w-7xl px-6 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center items-center gap-2 mt-4 md:hidden" id="erp-portfolio-dots">
