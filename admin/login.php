                ...
                <div class="form-inner" style="display: flex; flex-direction: column; gap: 1.5rem;">
                    ...
                    <div style="text-align: center;">
                        <div style="display: flex; justify-content: center; margin-bottom: 0.75rem;">
                            <!-- Futuristic Hexagon / Cube Logo -->
                            <div style="width: 52px; height: 52px; border-radius: 16px; background: #0f172a; color: #ffffff; display: flex; align-items: center; justify-content: center; box-shadow: 0 10px 15px -3px rgba(15, 23, 42, 0.15);">
                                <svg style="width: 30px; height: 30px; color: #38bdf8;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <!-- Divider -->
                    <div style="position: relative; display: flex; align-items: center; justify-content: center; padding-top: 0.25rem;">
                        <div style="border-top: 1px solid #e2e8f0; width: 100%;"></div>
                        <span style="position: absolute; background: #ffffff; padding: 0 0.75rem; font-size: 11px; font-weight: 500; color: #94a3b8; letter-spacing: 0.05em; text-transform: uppercase;">
                            or continue with
                        </span>
                    </div>
                    ...
                    <button
                        type="button"
                        onclick="alert('Google Authentication is available in Enterprise Edition.');"
                        style="width: 100%; border-radius: 0.75rem; border: 1px solid #e2e8f0; background: #ffffff; padding: 0.625rem 1rem; font-size: 0.75rem; font-weight: 600; color: #334155; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 0.625rem; transition: all 0.15s; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);">
